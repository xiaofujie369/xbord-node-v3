...
class ServerService
{
    ...
    public static function getAvailableServers(User $user): array
    {
        ...
        // This is the client/subscription boundary; node/admin APIs retain keys.
    ...
    public static function buildNodeConfig(Server $node): array
    {
        ...
        $response = match ($nodeType) {
            ...
            'anytls' => [
                ...
                'server_port' => (int) $serverPort,
                'tls' => (int) $protocolSettings['tls'],
                'server_name' => data_get($protocolSettings, (int) $protocolSettings['tls'] === 2 ? 'reality_settings.server_name' : 'tls_settings.server_name'),
                'tls_settings' => (int) $protocolSettings['tls'] === 2
        ...
        if (!empty($node['cert_config']) && !($nodeType === Server::TYPE_ANYTLS && (int) $protocolSettings['tls'] !== 1)) {
